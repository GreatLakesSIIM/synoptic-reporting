...
class Application(tk.Frame):
    ...
    def addTextFieldRow(self, parent, id, name, defaultValue, iRow):
        ...
        self.formInfo['fields'][id] = {'name':name,'value':tk.StringVar(value=defaultValue)}
        ...
        setattr(self.formFrame,id+'entry',tk.Entry(master=parent,width=50, textvariable=self.formInfo['fields'][id]['value']))
    ...
    def jsonDump(self):
        ...
        for field, values in self.formInfo['fields'].items():
            self.patientInfo['dump']['form'][field] = {'name':values['name'],'value':values['value'].get()}
